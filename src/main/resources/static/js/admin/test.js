...
//           var newContentHeight = isHourView ? 634 : 2430;
...
//         $(info.el).css("border", "1px solid red");
...
//       if (isOldEvent) {
//         const confirmed = confirm("Phim đã lên suất chiếu. Bạn có chắc muốn thay đổi không?");
//         if (!confirmed) {
//           info.revert(); // Nếu không xác nhận, hoàn tác thay đổi
//         } else {
//           // Cập nhật lịch chiếu
...
//     return;
//   }
//   if (roomId === "Chọn Phòng Chiếu Phim" || roomId === undefined) {
//     toastr.error("Chọn phòng chiếu phim");
//     return;
//   }
//   if (schedules.length === 0) {
//     toastr.error(
//       "Lịch chiếu phim trống. Vui lòng thêm ít nhất một lịch chiếu."
//     );
//     return;
//   }
//   var hasEmptyEndTime = schedules.some(function (schedule) {
//     return !schedule.end || schedule.end === ""; // end rỗng hoặc undefined
//   });
//   if (hasEmptyEndTime) {
...
//   // Khi tất cả các request trong requests hoàn thành
//   $.when.apply($, requests).done(function () {
//     if (!hasError) { // Chỉ thông báo thành công nếu không có lỗi
//       var requests2 = []; // Khởi tạo requests2 ở đây
...
//       // Khi tất cả các request trong requests2 hoàn thành
//       $.when.apply($, requests2).done(function () {
//         if (!hasError) {
//           toastr.success("Cập nhật lịch chiếu phim thành công");
//           renderCalendar(calendars);
//         } else {
//           toastr.error("Có lỗi trong quá trình cập nhật lịch chiếu phim thứ hai.");
//         }
//       });
//     } else {
